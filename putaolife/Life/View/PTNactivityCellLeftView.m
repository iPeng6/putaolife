...
@interface PTNactivityCellLeftView()
@property(nonatomic,strong) UILabel *lbTitle;
@property(nonatomic,strong) UILabel *lbSubTitle;
@property(nonatomic,strong) UIImageView *imgView;
@end
@implementation PTNactivityCellLeftView
...
-(UIImageView *)imgView{
    if (_imgView == nil) {
        ...
        [_imgView mas_makeConstraints:^(MASConstraintMaker *make) {
            make.top.equalTo(_lbSubTitle.mas_bottom).offset(20);
            make.left.equalTo(_lbSubTitle);
